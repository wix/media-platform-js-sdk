...
describe('image url parsing', function () {
    ...
    describe('correctly handles schemes', function () {
        ...
        it('https', function () {
            var operation = toImageRequest('https://test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg');
        ...
        it('without', function () {
            var operation = toImageRequest('//test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg');
