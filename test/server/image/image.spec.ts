...
describe('image url construction', () => {
  const imageUrl =
    '//test.com/1111/images/324234/v1/crop/w_709,h_400,x_1,y_2,scl_1,q_75,usm_0.5_0.2_0.0/file.png#w_1000,h_2000,mt_image%2Fpng';
  ...
  describe('handles input errors', () => {
    it('collects errors into a single Error instance', () => {
      ...
      expect((result.error as Error).message).to.equal(
        'jpeg compression quality: 200 is not a number between 0 to 100,saturation: 500 is not a number between -100 to 100,unsharp mask radius: -1 is not a number between 0.1 to 128',
      );
    });
  });
  ...
  describe('geometry', () => {
    ...
    it('rounds w values down', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/crop/w_100,h_200,x_0,y_0,usm_0.50_0.20_0.00/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('reject width values smaller than 1', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'width: 0 is not a number greater than 1',
      );
    });
    ...
    it('reject height values smaller than 1', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'height: -1 is not a number greater than 1',
      );
    });
  ...
  describe('fills a container with region of interest', () => {
    const image = new Image(
      '//fish.com/1234/5678/file.png/v1/crop/w_709,h_400/file.png#w_1926,h_1086,mt_image/png',
    );
    ...
    it('scale to width - without ROI', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_1000,h_564,x_0,y_0,scl_0.5192107995846313/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('scale to width - with ROI', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_1000,h_417,x_1833,y_375,scl_1.6666666666666667/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('scale to width - illegal width argument', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'crop scale factor: -0.0009208103130755065 is not a number between 0 to 100,width: -1 is not a number greater than 1,height: -1 is not a number greater than 1',
      );
    });
    ...
    it('scale to height - without ROI', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_887,h_500,x_0,y_0,scl_0.4604051565377532/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('scale to height - with ROI', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_208,h_500,x_345,y_291,scl_0.8333333333333334/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('scale to height - illegal height argument', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'crop scale factor: -0.27624309392265195 is not a number between 0 to 100,width: -532 is not a number greater than 1,height: -300 is not a number greater than 1',
      );
    });

    it('roi - landscape -> portrait', () => {
      const roi = new Rectangle(600, 250, 1100, 225);
      const container = new Dimension().setWidth(200).setHeight(300);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_200,h_300,x_1580,y_270,scl_1.2/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - landscape -> landscape', () => {
      const roi = new Rectangle(600, 250, 1100, 225);
      const container = new Dimension().setWidth(300).setHeight(200);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_300,h_200,x_550,y_75,scl_0.5/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - portrait -> landscape', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_300,h_200,x_498,y_680,scl_1.2/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - portrait -> portrait', () => {
      const roi = new Rectangle(250, 600, 415, 350);
      const container = new Dimension().setWidth(400).setHeight(500);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_400,h_500,x_249,y_291,scl_0.8333333333333334/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - square -> portrait', () => {
      ...
      const container = new Dimension().setWidth(900).setHeight(1000);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_900,h_1000,x_3150,y_1475,scl_2.5/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - square -> landscape', () => {
      const roi = new Rectangle(400, 400, 1240, 590);
      const container = new Dimension().setWidth(1000).setHeight(600);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_1000,h_600,x_3100,y_1675,scl_2.5/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - square -> square', () => {
      const roi = new Rectangle(400, 400, 1240, 590)
        ...
        .setY(590)
        .setHeight(400);
      const container = new Dimension().setWidth(250).setHeight(250);

      const result = image.fillContainer(container, roi).toUrl();

      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_250,h_250,x_775,y_368,scl_0.625/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - full image -> square', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//fish.com/1234/5678/file.png/v1/crop/w_250,h_250,x_97,y_0,scl_0.2302025782688766/file.png#w_1926,h_1086,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('roi - handles bleeding top, right', () => {
      ...
      const container = new Dimension().setWidth(200).setHeight(200);
    ...
    it('scale to width - missing image basic data', () => {
      const scaledImage = new Image(
        '//fish.com/1234/5678/file.png/v1/crop/w_709,h_400/file.png',
      );
      ...
      try {
        ...
        expect(e.message).to.equal(
          'client side manipulation requires image basic metadata',
        );
      }
    });
  });
  ...
  describe('crop geometry', () => {
    ...
    it('scale is optional', () => {
      ...
      expect(crop.toUrl()).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/crop/w_90,h_91,x_100,y_101,usm_0.50_0.20_0.00/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('reject x values smaller than 0', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'crop x: -1 is not a number greater than 0',
      );
    });
    ...
    it('reject y values smaller than 0', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'crop y: -1 is not a number greater than 0',
      );
    });

    it('all options', () => {
      const result = image
        .crop(101, 102, 81, 82, 1.2)
        .jpeg(100, true)
        .unsharpMask(10, 8, 9)
        .blur(10)
        .saturation(-70)
  ...
  describe('smart crop geometry', () => {
    ...
    it('all options', () => {
      ...
      expect(result).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/scrop/w_101,h_102,blur_10,br_99,con_12,hue_60,q_100,bl,sat_-70,usm_10.00_8.00_9.00/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
  });
  ...
  describe('watermark manifest', () => {
    ...
    it('watermark', () => {
      ...
      expect(watermark.toUrl()).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/crop/w_400,h_709,x_1,y_2,scl_1,usm_0.50_0.20_0.00,wm_manifest/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
  ...
  describe('fill geometry', () => {
    ...
    it('fill', () => {
      ...
      expect(fill.toUrl()).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/fill/w_90,h_91,usm_0.50_0.20_0.00/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
    ...
    it('reject h values smaller than 1', () => {
      ...
      expect(result.url).to.equal(null);
      expect((result.error as Error).message).to.equal(
        'height: 0 is not a number greater than 1',
      );
    });
  });
  ...
  describe('fit geometry', () => {
    ...
    it('fit', () => {
      ...
      expect(fit.toUrl()).to.deep.equal({
        url:
          '//test.com/1111/images/324234/v1/fit/w_90,h_91,usm_0.50_0.20_0.00/324234#w_1000,h_2000,mt_image%2Fpng',
        error: null,
      });
    });
  ...
  describe('url normalization', () => {
    ...
    it('preserves parameter order', () => {
      ...
      expect(result1.url).to.equal(
        '//test.com/1111/images/324234/v1/crop/w_100,h_200,x_1,y_2,scl_3.0,blur_10,br_10,con_10,hue_10,q_10,sat_10,usm_1.00_2.00_3.00/324234#w_1000,h_2000,mt_image%2Fpng',
      );
