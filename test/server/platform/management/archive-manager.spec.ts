...
describe('archive manager', () => {
  ...
  it('should create archive observable error', (done) => {
    ...
    apiServer
      ...
      .replyWithFile(
        200,
        path.join(repliesDir, 'create-archive-error-response.json'),
      );
  ...
  it('extract archive', (done) => {
    ...
    archiveManager
      .extractArchive(extractArchiveRequest)
  ...
  it('should extract archive observable', (done) => {
    ...
    apiServer
      ...
      .replyWithFile(
        200,
        path.join(repliesDir, 'extract-archive-success-response.json'),
      );
  ...
  it('should extract archive observable error', (done) => {
    ...
    apiServer
      ...
      .replyWithFile(
        200,
        path.join(repliesDir, 'extract-archive-error-response.json'),
      );
