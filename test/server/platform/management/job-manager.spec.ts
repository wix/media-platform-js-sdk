...
import {
  ...
  Job,
  JobStatus,
} from '../../../../src/platform/management/job/job';
      ...
      new SearchJobsResponse({
        ...
        jobs: [
          ...
          },
          {
            ...
            id:
              'e8e1d5908cde4883ac30176f5ebdd68f_7b99c2ce4b5c46298ec0d02889142aa7',
            ...
            sources: [
              {
                path:
                  '/_end2end_test/uploaded/49c15451069444889093e8da6b715643.mp4',
            ...
            result: {
              ...
              payload: {
                ...
                file: {
                  ...
                  path:
                    '/test/outputs/144p/49c15451069444889093e8da6b715643.mp4',
                  id: '13163e5951ed4cfbaaaf6289a5a03420',
                  size: 2963744,
                  ancestors: ['/test', '/test/outputs', '/test/outputs/144p'],
                  acl: 'public',
                  dateUpdated: '2017-05-23T23:14:31Z',
                  type: '-',
                },
