...
describe('liveManager', () => {
  ...
  it('Publish Endpoint is parsing properly', done => {
    ...
    liveManager.getStream('stream_id')
      .then(data => {
        expect(data.publishEndpoint).to.be.an.instanceof(PublishEndpoint);
        expect(data.publishEndpoint && data.publishEndpoint.protocol).to.equal('rtmp');
  ...
  it('Analytics is parsing properly', done => {
    ...
    liveManager.getStreamAnalytics('stream_id')
      .then(data => {
  ...
  it('Create Live Stream', done => {
    ...
    liveManager.openStream(livestreamRequest)
      .then(data => {
  ...
  describe('closeStream', () => {
    it('should resolve promise', done => {
      ...
      liveManager.closeStream('stream_id')
        .then(() => {
          done();
        });
    });
  ...
  describe('listStreams', () => {
    it('should return list of streams', done => {
      ...
      liveManager.listStreams(liveStreamListRequest)
        .then(data => {
