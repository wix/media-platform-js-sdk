 ...
 */
function Canvas(baseUrl, imageId, imageName, version, width, height, originalFileData) {
    BaseOperation.call(this, 'canvas', baseUrl, imageId, imageName, version, width, height, originalFileData);
